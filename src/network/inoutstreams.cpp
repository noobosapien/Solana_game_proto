...
InputStream::InputStream(uint8_t *inBuffer, uint32_t bitCount) : mBuffer(inBuffer), mBitCapacity(bitCount), mBitHead(0), mIsBufferOwner(false)
{
}

InputStream::InputStream(InputStream &other) : mBitCapacity(other.mBitCapacity), mBitHead(other.mBitHead),
                                               mIsBufferOwner(true)
{
